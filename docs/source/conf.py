...
# -*- coding: utf-8 -*-
#
# widget_jsmol documentation build configuration file
#
...
_version_py = os.path.join(repo, 'widget_jsmol', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'widget_jsmoldoc'
...
latex_documents = [
    (master_doc, 'widget_jsmol.tex', 'widget_jsmol Documentation',
     'Dou Du', 'manual'),
]
